...
curl -X POST http://localhost:3002/compare \
  ...
  -d '{
    "target_url": "https://static.wikia.nocookie.net/amazingspiderman/images/3/33/Tobey_Maguire_Infobox.png/revision/latest/scale-to-width-down/535?cb=20240322015635",
    "people": [
    {
      "name": "Maguire",
      "image_url":
...
iris/
├── api/                # The "Engine" (Rust + OpenCV)
│   ├── src/
│   ├── Cargo.toml
│   └── setup.sh
├── web/                # The "Interface" (React Js Landing Page)
│   ├── src/
│   └── package.json
└── README.md           # The "Pitch" (Master Documentation)
```
